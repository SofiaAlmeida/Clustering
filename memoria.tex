...
\begin{figure}[h]
  ...
  \begin{minipage}[h]{0.29\textwidth}
    \includegraphics[width=\textwidth]{setosa.jpg}
    \caption{Iris Setosa.}
  \end{minipage}
  \hfill
  \begin{minipage}[h]{0.3\textwidth}
    \includegraphics[width=\textwidth]{virginica.jpg}
    \caption{Iris virginica.}
  \end{minipage}
  \hfill
  \begin{minipage}[h]{0.31\textwidth}
    \includegraphics[width=\textwidth]{versicolor.jpg}
...
Para el algoritmo K-Means se ha utilizado el siguiente código en python y se ha obtenido la siguiente agrupación de las muestras, donde el cluster 0 representa las \textbf{Iris} versicolor, el cluster 1 setosa y el cluster 2 virginica:\\
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.62]{scatmatrixK-MeansIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.62]{heatmapK-MeansIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{kdeplotK-MeansIRIS.png}
\includegraphics[scale=0.32]{boxplotK-MeansIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.62]{scatmatrixAggClusterIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.62]{heatmapAggClusterIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.35]{dendrogramAggClusterIRIS.png}
\includegraphics[scale=0.37]{dendscatAggClusterIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.64]{scatmatrixDBSCANIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.62]{heatmapDBSCANIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.64]{scatmatrixMeanShiftIRIS.png}
...
\begin{figure}[h]
\centering
\includegraphics[scale=0.62]{heatmapMeanShiftIRIS.png}
